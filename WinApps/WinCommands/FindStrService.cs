...
namespace WinCommands
{
    public class FindStrService
    {
        ...
        public async Task<List<FindStrSingleResult>> RequestServiceAsync(string path, string textToSearch, string fileExtension)
        {
            ...
            return FindStrSingleResult.GetFindStrResults(winCommandResult, textToSearch);
        }
    }
}
